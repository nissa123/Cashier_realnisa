    ...
    <table class="table table-striped rounded overflow-hidden" id="myTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $j->kategori_id }}</td>
                <td>
                    <button type="button" class="btn btn-success btn-size" data-bs-toggle="modal" data-bs-target="#modalEdit" data-mode="edit" data-id="{{ $j->id }}" data-nama_jenis="{{ $j->nama_jenis }}" data-kategori_id="{{ $j->kategori_id }}">
